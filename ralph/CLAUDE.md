...
For any story that tests or changes UI, use **Playwright headless** to verify:

### Quick Playwright Test Pattern

```typescript
// Create a test file or run inline with npx playwright test
...
If Playwright is not installed, note in progress report: "Playwright not available - manual browser verification needed"
