...
const systemTemplates = [
  {
    ...
    sections: [
      ...
      {
        title: 'Way Forward',
        placeholder: 'What will the client do next?',
        type: 'textarea' as const,
      },
    ],
    isSystem: true,
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'Achievable',
        placeholder: 'Is this goal realistic? What resources are needed?',
        type: 'textarea' as const,
      },
      {
        title: 'Relevant',
        placeholder: 'Why does this goal matter? How does it align with broader objectives?',
        type: 'textarea' as const,
      },
      {
        title: 'Time-bound',
        placeholder: 'What is the deadline or timeline?',
        type: 'textarea' as const,
      },
      {
        title: 'Action Plan',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: 'Key Insights',
        placeholder: 'What insights or breakthroughs emerged?',
        type: 'textarea' as const,
      },
      {
        title: 'Action Items',
        placeholder: 'What actions did the client commit to?',
        type: 'textarea' as const,
      },
      {
        title: 'Follow-up Notes',
        placeholder: 'What to follow up on in the next session?',
        type: 'textarea' as const,
      },
    ],
    isSystem: true,
  ...
  },
  {
    ...
    sections: [
      {
        title: 'Discovery',
        placeholder: 'What is working well? What strengths were identified?',
        type: 'textarea' as const,
      },
      {
        title: 'Dream',
        placeholder: 'What does the ideal future look like?',
        type: 'textarea' as const,
      },
      {
        title: 'Design',
        placeholder: 'What changes or structures will support the dream?',
        type: 'textarea' as const,
      },
      {
        title: 'Destiny',
        placeholder: 'What commitments and next steps were agreed upon?',
        type: 'textarea' as const,
      },
    ],
    isSystem: true,
...
async function seed() {
  ...
  const inserted = await db
    ...
    .values(toInsert)
    .returning({ id: sessionNoteTemplates.id, name: sessionNoteTemplates.name });
