        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-blue-500/30">
            <p className="text-blue-100 text-sm">
              &quot;The sign-up process was simple, and I found my perfect coach within a day.
              Best decision I&apos;ve made for my personal growth!&quot;
            </p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50 p-8">
        <div className="w-full max-w-md">
          ...
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Create an account to find your perfect coach</p>
          </div>
