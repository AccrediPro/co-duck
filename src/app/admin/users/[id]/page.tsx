        ...
        <Card>
          ...
          <CardContent>
            <div className="flex flex-wrap items-center gap-4">
              <Badge variant={getVerificationVariant(user.coachProfile.verificationStatus)} className="capitalize">
              ...
              {user.coachProfile.headline && (
                <span className="text-sm text-muted-foreground">{user.coachProfile.headline}</span>
              )}
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-4">
              ...
              <BookingStatusBreakdown
                label="As Coach"
                data={activity.bookingsAsCoach}
              />
              <BookingStatusBreakdown
                label="As Client"
                data={activity.bookingsAsClient}
              />
            </div>
