          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm">
                ...
                <span>Stripe: {coach.stripeOnboardingComplete ? 'Connected' : 'Not connected'}</span>
              </div>
              <div className="pt-1">
                <Link
          ...
          <Card>
            ...
            <CardContent>
              {specialties.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground italic">No specialties listed</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {sessionTypes.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground italic">No session types configured</p>
              )}
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Approve or reject this coach&apos;s profile
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CoachVerifyActions
